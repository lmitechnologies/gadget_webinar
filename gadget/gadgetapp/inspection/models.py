...
available_decisions=['empty','peeling','catheter','white','scuff']
...
INSPECTION_RESULT_KEYS={   
    0:{'service_type':'pipeline','instance_name':'demo-pipeline','instance':0,'sensor_topic':'sensor/gadget-sensor-avt/0'},
}
...
class ConfigUI(models.Model):
    ...
    plot_options=[(0,'none'),(1,'line'),(2,'bar'),(3,'doughnut')]
...
class UserPipelineConfig(models.Model):
    confidence_peeling=models.FloatField(default=0.5)
    confidence_catheter=models.FloatField(default=0.5)
    confidence_white=models.FloatField(default=0.5)
    confidence_scuff=models.FloatField(default=0.5)
#--
...
class UserAutomationConfig(models.Model):
    ...
    mark_peeling=models.BooleanField(blank=True, default=True)
    mark_white=models.BooleanField(blank=True, default=True)
    mark_scuff=models.BooleanField(blank=True, default=True)#--
class SystemState(models.Model):
    running=models.BooleanField(default=False)

class TestClass(models.Model):
    test_var=models.BooleanField(default=False)
